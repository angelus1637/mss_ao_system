...
local function ShowEditMenu(data, edit, edit_id)
	...
	if data["aotype"] then
		if data["aotype"] == "standard" then
			...
			ao_depsignals_lb:SetText("Контрольные сигналы:")
			...
			ao_route_lb:SetText("Основной маршрут:")
		...
		elseif data["aotype"] == "zone_int" then
			...
			ao_depsignals_main_lb:SetText("Контрольные сигналы по прямой:")
			...
			ao_depsignals_alt_lb:SetText("Контрольные сигналы в тупик:")
			...
			ao_checksignal_lb:SetText("Контрольный сигнал:")
		...
		elseif data["aotype"] == "by-block-sections" then
			...
			ao_deproute_lb:SetText("Контрольный маршрут:")
